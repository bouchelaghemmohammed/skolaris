...
{
    /// <inheritdoc />
    public partial class AddEmploiDuTemps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdCreateur = table.Column<int>(type: "int", nullable: true),
                    EstAnnonce = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PieceJointePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PieceJointeNom = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    EstSignale = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublie = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IdCoursOffert = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
